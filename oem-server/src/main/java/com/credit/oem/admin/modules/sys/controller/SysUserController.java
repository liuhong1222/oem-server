...
import com.credit.oem.admin.common.validator.group.AddGroup;
import com.credit.oem.admin.common.validator.group.UpdateGroup;
...
import com.credit.oem.admin.modules.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        //只有管理员角色才能查看
        List<SysUserRoleEntity> sysUserRoleEntityList = sysUserRoleDao.selectList(new EntityWrapper<SysUserRoleEntity>().
                eq("role_id", "1").eq("user_id", getUserId()));
