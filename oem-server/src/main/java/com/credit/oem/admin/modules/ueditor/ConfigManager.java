package com.credit.oem.admin.modules.ueditor;


import com.credit.oem.admin.modules.ueditor.define.ActionMap;
...
//		this.originalPath = "src/main/resources/editor/config-dev.json";
    ...
    private void initEnv() throws FileNotFoundException, IOException {
        ...
        ClassPathResource classPathResource = new ClassPathResource(EditorConfig.ueditorConfigPath);
        InputStream inputStream = classPathResource.getInputStream();
        configContent = this.readFile(inputStream);
...
//		return "D:\\tools\\ideawork\\OEM\\oem-server\\src\\main\\resources\\editor\\config-dev.json";
